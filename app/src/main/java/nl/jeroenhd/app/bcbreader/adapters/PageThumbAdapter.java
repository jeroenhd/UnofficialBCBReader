...
public class PageThumbAdapter extends RecyclerView.Adapter<PageThumbAdapter.ViewHolder> {
    ...
    @Override
    public PageThumbAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(PageThumbAdapter.ViewHolder holder, int position) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(final View itemView, OnThumbClickListener onThumbClickListener) {
            ...
            this.pageThumbImageView = (PageThumbImageView) itemView.findViewById(R.id.thumb);
            this.pageThumbImageView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onClick.onThumbnailClick(mChapter, page, v);
                }
            });
            this.pageText = (TextView) itemView.findViewById(R.id.text);
